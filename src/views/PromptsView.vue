...
.prompt-layout {
  display: grid;
  grid-template-columns: 210px minmax(310px, 1fr) minmax(290px, 0.85fr);
  gap: 19px;
  align-items: start;
}
.prompt-list {
...
.new-variable .el-button {
  padding: 8px;
}
.prompt-test .markdown {
  font-size: 11px;
}
.prompt-test .empty-state {
  padding: 55px 10px;
}
.version-row {
  display: flex;
